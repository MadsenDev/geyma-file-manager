...
If `.venv/` already exists in the repo, `python -m geyma` will automatically re-run itself with that environment when your current interpreter is missing `PySide6`.
