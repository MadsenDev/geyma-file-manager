    ...
    case "nav":
      return (
        <>
          ...
          <path
            d="M40 23V12M36 15.5 40 12l4 3.5"
            stroke={c.accentSoft}
            {...STROKE}
          />
        </>
          ...
          {[4, 16, 28, 40].map((x, i) =>
            [6, 19].map((y, j) => (
              <rect
                ...
                height="9"
                rx="2"
                fill={i === 0 && j === 0 ? c.accentSoft : c.faint}
              />
            )),
          )}
        </>
      ...
      return (
        <>
          ...
          {[5, 14].map((x) =>
            [7, 17].map((y) => (
              <rect
                key={tr("ui.module_preview.l_x_y", {
                  x,
                  y,
                })}
                x={x}
          ...
          {[31, 40].map((x, i) =>
            [7, 17].map((y, j) => (
              <rect
                key={tr("ui.module_preview.r_x_y", {
                  x,
                  y,
                })}
                x={x}
    ...
    case "settings":
      return (
        <>
          ...
          <path
            d="M26 8v3M26 23v3M17 17h3M32 17h3M19.6 10.6l2.1 2.1M30.3 21.3l2.1 2.1M32.4 10.6l-2.1 2.1M21.7 21.3l-2.1 2.1"
            stroke={c.soft}
            {...STROKE}
          />
        </>
    ...
    case "network":
      return (
        <>
          ...
          <path
            d="M26 7c3.1 2.7 4.9 6.1 4.9 10s-1.8 7.3-4.9 10c-3.1-2.7-4.9-6.1-4.9-10s1.8-7.3 4.9-10z"
            stroke={c.soft}
            {...STROKE}
          />
        </>
    ...
    case "mood":
      return (
        <>
          ...
          />
          <path
            d="M21.5 20c1.2 1.5 2.7 2.3 4.5 2.3s3.3-.8 4.5-2.3"
            stroke={c.accent}
            {...STROKE}
          />
        </>
