...
export function Dupes() {
  ...
  return (
    <div>
      <div style={panelTitleStyle(t)}>{tr("ui.dupes.duplicates")}</div>
      <div
        style={{
          padding: "0 8px 8px",
          display: "flex",
        ...
        {groups.map(([key, list]) => {
          ...
          return (
            <button
              ...
              onContextMenu={(event) =>
              openReferencedPathMenu(event, list[0].path)
              }
              style={{
                textAlign: "left",
                border: 0,
        ...
        <div
          style={{
            ...
            {tr("ui.dupes.no_duplicates_found_the_keeper_is_tidy")}
          </div>
        }
      </div>
    </div>);
