...
export function navItemStyle(t: ResolvedTheme, active: boolean, dragOver: boolean): React.CSSProperties {
  return {
    display: "flex",
    alignItems: "center",
    gap: 9,
    ...
    textAlign: "left",
    width: "100%",
    ...(dragOver ? { outline: `2px solid ${t.accent}`, outlineOffset: -2, background: hexA(t.accent, 0.14) } : {}),
  };
}

export function iconButtonStyle(t: ResolvedTheme, active = false): React.CSSProperties {
  return {
    width: 28,
    height: 28,
    display: "grid",
...
export function chipStyle(t: ResolvedTheme, active: boolean): React.CSSProperties {
  return {
    height: 22,
    display: "inline-flex",
    alignItems: "center",
